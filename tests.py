...
class SparseDTWTest(TestCase):
    ...
    def test_quantize(self):
        a, b = dtw.quantize(self.s, self.q)
    ...
    def test_euc_dist(self):
        self.assertEqual(dtw.euc_distance(5,7), 4)

    def test_populate_warp(self):
        a = dtw.populate_warp(self.s, self.q, 0.5)
    ...
    def test_unblock_warp_matrix(self):
        SM = dtw.populate_warp(self.s, self.q, 0.5)
        a = dtw.calculat_warp_costs(self.s, self.q, SM)
